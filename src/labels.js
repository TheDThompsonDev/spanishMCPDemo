export const labels = {
  ...
  mcpSection: {
    ...
    subtitle:
      "The Model Context Protocol (MCP) is a standardized way for applications to interact with AI models by providing relevant context to enhance the quality and relevance of AI-generated responses.",
    howItWorks: {
      title: "How MCP Works",
      description1:
        "MCP enables applications to provide specific context to AI models, making their responses more accurate and relevant. For language learning, this means providing vocabulary, grammar rules, and personalized content.",
      description2:
    ...
    items: [
      {
        ...
        description:
          "Provides relevant vocabulary, grammar, and learning materials as context to the AI model",
      },
      {
      ...
      },
      {
        ...
        description:
          "Tracks vocabulary mastery, grammar understanding, and overall learning progress",
      },
      {
        title: "Translation Services",
        description:
          "Provides accurate translations with context-aware understanding",
      },
    ],
  },
  mcpProtocolSteps: [
    {
      ...
      description:
        "The MCP client discovers available learning resources from the server",
    ...
    },
    {
      ...
      description:
        "The MCP server provides specific learning resources based on the request",
      code: `POST /mcp/resources/read
{
  ...
  "params": {
    ...
    },
    {
      ...
      description:
        "The MCP server executes a translation tool with the provided context",
      code: `POST /mcp/tools/call
{
  ...
  "params": {
    ...
    },
    {
      label: "Tool Response",
      description:
        "The MCP server returns the tool execution result to the client",
      code: `{
  "method": "tools/call",
  "result": {
    "content": [
    ...
    types: [
      {
        name: "vocabulary",
        color: "#4caf50",
        description: "Vocabulary and translations with examples",
      },
      {
        name: "grammar",
        color: "#2196f3",
        description: "Spanish grammar rules and usage",
      },
      {
        name: "mixed",
        color: "#ff9800",
        description: "Combined vocabulary and grammar",
      },
      {
        name: "conversation",
        color: "#9c27b0",
        description: "Conversational phrases and patterns",
      },
      { name: "exercise", color: "#8bc34a", description: "Practice exercises" },
      {
        name: "assessment",
        color: "#795548",
        description: "Skill assessment materials",
      },
      {
        name: "personalized",
        color: "#f44336",
        description: "Adaptive content based on user progress",
      },
    ],
  },
  apiEndpoints: {
  ...
  apiExplorer: {
    ...
    simulatedResponses: {
        ...
        data: [
          {
            ...
            context_window: 4096,
            description:
              "Specialized model for Spanish language learning with enhanced context awareness",
          },
        ],
      },
      context: {
      ...
      query: {
        ...
        answer:
          "Both 'ser' and 'estar' mean 'to be' in English, but they are used in different contexts. 'Ser' is used for permanent characteristics, identity, and essence, while 'estar' is used for temporary states, locations, and conditions.",
        examples: [
          {
            verb: "ser",
  ...
  contextVisualizer: {
    ...
    labels: {
      ...
      headerDescription:
        "This demo shows how the MCP server generates adaptive context for Spanish learning. The context is used to enhance AI model responses with relevant vocabulary, grammar, and learning materials.",
      ...
      compositionDescription:
        "This shows how the context is structured and what percentage each section contributes.",
      compositionChip: "Analysis",
      loadingTitle: "Generating Context",
      loadingDescription:
        "The MCP server is processing your request and generating relevant learning context...",
      loadingNote:
        "Real-world MCP servers can cache context for faster retrieval and better performance.",
      badges: {
      ...
      configurationAlert: {
        ...
        description:
          "This configuration determines what type of Spanish learning context will be generated. Different settings create context optimized for various learning scenarios.",
      },
      metricsAlert: {
        title: "Performance Metrics:",
        description:
          "These metrics show the efficiency of context generation and help optimize the learning experience.",
      },
      processExplanation: {
      ...
      emptyState: {
        ...
        description:
          "Click the 'Generate Context' button to see how the MCP server creates learning-specific context.",
      ...
      successAlert: {
        ...
        description:
          "The content below shows the structured context that would be provided to an AI model for enhanced Spanish learning responses.",
      },
    },
  },
  mcpFlow: {
    ...
    steps: [
      {
        ...
        description:
          "The client sends a request to the MCP server with a prompt and optional parameters.",
        request: {
      ...
      },
      {
        ...
        description:
          "The MCP server retrieves or generates appropriate context based on the request parameters.",
        request: {
      ...
      },
      {
        ...
        description:
          "The AI model processes the request with the provided context to generate a response.",
        request: {
          internal: true,
          body: {
            model: "claude-3-opus-20240229",
            prompt:
              "<context># Spanish Restaurant Phrases\n\n## Ordering\n\n### coffee\n- **Translation:** café\n- **Difficulty:** beginner\n\n**Examples:**\n- Spanish: Me gustaría un café, por favor.\n  English: I would like a coffee, please.\n\n- Spanish: ¿Puedo pedir un café?\n  English: Can I order a coffee?\n\n### order\n- **Translation:** pedir\n- **Difficulty:** beginner\n\n**Examples:**\n- Spanish: Quiero pedir algo de beber.\n  English: I want to order something to drink.</context>\n\nTranslate to Spanish: I would like to order a coffee, please.",
            max_tokens: 100,
            temperature: 0.7,
          },
        },
      ...
      },
      {
        ...
        description:
          "The MCP server returns the AI-generated response to the client.",
        response: {
          object: "generation",
          model: "spanish-learning-model",
          choices: [
    ...
    simulatedData: {
      ...
      achievements: [
        ...
        },
        {
          ...
          description: "Learned 100 Spanish vocabulary words",
          completed: true,
        },
        {
          title: "Grammar Expert",
          description: "Mastered 20 grammar concepts",
          completed: false,
          progress: 0.75,
        },
      ],
    ...
    sessionTypes: [
      {
        ...
        description: "General Spanish learning session",
      },
      {
        value: "vocabulary",
        label: "Vocabulary Practice",
        description: "Focus on vocabulary acquisition",
      },
      {
        value: "grammar",
        label: "Grammar Practice",
        description: "Focus on grammar rules and usage",
      },
      {
        value: "conversation",
      ...
      },
      {
        ...
        description: "Evaluate current Spanish proficiency",
      },
    ],
    activityIcons: {
      context: "info",
  ...
  app: {
    ...
    dashboard: {
      ...
      welcome:
        "Welcome to the Spanish Learning MCP Demo. This interactive demo showcases how the Model Context Protocol enhances Spanish language learning through context-aware AI interactions.",
      features: {
        ...
        mcp: {
          ...
          endpoints: {
            resources: {
              ...
              description:
                "Lists available learning resources including vocabulary, grammar, and exercises.",
            },
            resourceRead: {
              title: "POST /mcp/resources/read",
              description:
                "Reads specific learning resources with contextual metadata.",
            },
            tools: {
              title: "POST /mcp/tools/call",
              description:
                "Executes learning tools like translation and conjugation with context.",
            },
          },
        },
        tools: {
          ...
          endpoints: {
            translator: {
              ...
              description:
                "Context-aware translation tool between English and Spanish.",
            },
            conjugator: {
              title: "verb-conjugator",
              description:
                "Comprehensive Spanish verb conjugation with contextual examples.",
            },
            assessor: {
              title: "skill-assessor",
              description:
                "Skill assessment tool with personalized learning recommendations.",
            },
          },
        },
        session: {
          ...
          endpoints: {
            start: {
              ...
              description:
                "Starts a new learning session with specified type and lesson parameters.",
            },
            end: {
              title: "POST /api/session/end",
              description:
                "Ends an active learning session and saves progress data.",
            },
            progress: {
              title: "GET /api/progress",
              description:
                "Retrieves detailed learning progress and analytics for the user.",
            },
          },
        },
      },
